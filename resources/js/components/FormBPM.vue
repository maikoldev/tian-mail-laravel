  ...
  <div>
    <b-form @submit.prevent="onSubmit()">
      ...
      <b-form-group>
        ...
        >
          <b-form-invalid-feedback :state="validateState('documentType')">Este campo es requerido.</b-form-invalid-feedback>
        </b-form-radio-group>
      </b-form-group>
      ...
      <b-form-group>
        ...
        >Este campo debe un correo electronico valido.</b-form-invalid-feedback>
        <b-form-invalid-feedback v-if="!$v.form.email.required">Este campo es requerido.</b-form-invalid-feedback>
      </b-form-group>
    ...
    <b-alert
      ...
      fade
      variant="danger"
    >¡Ah ocurrido un error! Por favor, vuelve a intertarlo.</b-alert>

    <!-- Alert Success -->
    <b-alert :show="showAlert" class="mt-4" dismissible fade variant="success">
      <h4 class="alert-heading">¡Muy bien!</h4>
      <p>
        Tus datos se han enviado con éxito. Revisaremos tus datos y pronto recibirás tu carnet como
        manipulador de alimentos vía correo electrónico.
      </p>
    </b-alert>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      // Send Request
      axios
        .post(`${process.env.MIX_APP_URL}/generate-certificate`, params, config)
        .then((res) => {
          this.resetForm();
          this.showAlert = true;
        })
